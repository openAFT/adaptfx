...
For extended functions inspect value_eval or whole_plan. Also read the extended
function in the README file. The value eval function is build by assigning a
penalty depending on how much dose has been delivered to the OAR (in each
fraction) and by how far we are from the prescribed dose after the last
fractions.
"""
