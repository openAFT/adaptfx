...
import pandas as pd
import interpol3_min_max as intp3
import threading
...
class GUIextended3D:
    def __init__(self, master):
        ...
        self.frm_probdis = tk.Frame(relief=tk.SUNKEN, borderwidth=3)
        ...
        self.frm_extras = tk.Frame(master = self.master,relief = tk.SUNKEN, borderwidth = 3)
        ...
        self.frm_output = tk.Frame(relief=tk.SUNKEN, borderwidth = 3)
